...
$Text['do_preorder'] = "Activate/deactivate as preorder";
$Text['do_deactivate_prod'] = "Activate/deactivate entire product";
...
$Text['msg_delete_preorder_p'] = "Are you sure to delete this accumulative order?";
$Text['msg_err_no_provider'] = "You must select one provider from the droplist";
...
$Text['import_reset'] = "Deactivate all entries before creating new entries and updating existing ones";
